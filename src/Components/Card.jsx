...
function Card({ Data }) {
  ...
  return (
    <Link
      href={`./details`}
      className="flex flex-col bg-slate-50 items-center backdrop-blur-sm w-40 h-56 justify-center rounded-lg p-2 gap-y-3 shadow-sm shadow-zinc-400 hover:scale-110 hover:shadow-lg hover:shadow-emerald-400"
      key={Data.id}
